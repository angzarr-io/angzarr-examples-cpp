...
# Copy proto files from angzarr-project submodule (single source of truth)
COPY angzarr-project/proto ./angzarr-client-cpp/angzarr/proto

# Copy C++ client headers (router.hpp, aggregate.hpp, etc.)
COPY angzarr-client-cpp/include ./angzarr-client-cpp/include

# Remove ai_sidecar.proto (not used in C++ examples)
